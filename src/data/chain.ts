...
export const BLOCKS: Block[] = [
  ...
  },
  {
    ...
    location: 'Paris',
    type: 'project',
    description: 'Startup fork. React Native, Expo, TypeScript, Apollo Client, Prisma 2. Building products from zero.',
  ...
  },
  {
    ...
    location: 'Remote',
    type: 'project',
    description: 'Another startup block. Different domain, same passion for solving real problems.',
  ...
  },
  {
    ...
    location: 'Remote',
    type: 'current',
    description: 'Current block being mined. Self-custody DeFi. Open source. Decentralized. The chain continues...',
    transactions: createTransactions(['React', 'TypeScript', 'Web3', 'DeFi', 'Open Source', 'Self-Custody']),
    hash: '0x????????????????????????????????????????????????????????????????',
